...
- Added **Whitelist/Blacklist** tabs to the preset editor (presets now carry their own blacklist rules too).- Added `/cs blacklist addPreset <name> <blacklist|whitelist|everything>` to populate your global blacklist from preset rules
