...
public record SetContainerFiltersPayload(
    ...
    public static final Id<SetContainerFiltersPayload> ID = new Id<>(Identifier.of(Chestsort.MOD_ID, "set_container_filters"));

    public static final PacketCodec<RegistryByteBuf, SetContainerFiltersPayload> CODEC = PacketCodec.ofStatic(
        (buf, payload) -> {
