...
public record SetFilterV2Payload(String dimensionId, long posLong, ContainerFilterSpec filter) implements CustomPayload {
    public static final Id<SetFilterV2Payload> ID = new Id<>(Identifier.of(Chestsort.MOD_ID, "set_filter_v2"));

    public static final PacketCodec<RegistryByteBuf, SetFilterV2Payload> CODEC = PacketCodec.ofStatic(
        (buf, payload) -> {
